      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="text-center space-y-6">
          ...
          <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="px-8 py-4 bg-gaia-black text-gaia-yellow border-2 border-gaia-black hover:bg-green-400 hover:text-white transition-all flex items-center gap-2 font-medium text-lg group">
              Launch App
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="px-8 py-4 bg-transparent text-gaia-black border-2 border-gaia-black hover:bg-green-400 hover:text-white transition-all flex items-center gap-2 font-medium text-lg">
