...
# Use cast to send from Anvil account
cast send "$YOUR_ACCOUNT" --value 1000ether --rpc-url http://localhost:8545 --from 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266

echo ""
echo "Checking balance..."
BALANCE=$(cast balance "$YOUR_ACCOUNT" --rpc-url http://localhost:8545)
